...
int main(){
    ...
    memcpy(highpass_spc,pwr_spc,sizeof(double)*width*height);
    memcpy(lowpass_spc,pwr_spc,sizeof(double)*width*height);
...
void highPassFilter (double *pwr, int height, int width, int thre){
