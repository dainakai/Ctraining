...
const char* inputimage1 = "./test/test.bmp";
const char* inputimage2 = "./test/test1.bmp";
unsigned char header_buf [1078];

const char* outputdata = "testdata.dat";
...
const int L=32; // Length of inputting image square
...
const int Sx = 0; // half of horizontal extension of I winodw
const int Sy = 0; // half of vertical extension of I window
/***********************PARAMETERS END**************************/
...
////  changed changed tested image2[Sy + i*N/2 + k]
  ...
  //PNG image
	...
	fprintf(gp,"set output 'testresult.png'\n");
  ...
  // fprintf(gp,"set yrange reverse\n");
	...
	fprintf(gp,"plot 'testdata.dat' using 1:2:($3*0.50):($4*0.50)  w vector ti ''\n");
